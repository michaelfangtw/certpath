          ...
          <div style={{ padding: '24px 0', animation: 'slideUp 400ms var(--ease-out) both' }}>
            <div style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
              ...
              <div style={{
                ...
                background: '#FFF5EC', border: '1.5px solid #FFCDB8',
                borderRadius: 12, fontSize: 12.5, lineHeight: 1.5,
                color: 'var(--ink)', maxWidth: 320, textAlign: 'left',
              }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                  <span>⚡</span>
                  <span style={{ fontWeight: 900, color: '#C44818', fontSize: 11, letterSpacing: '0.05em' }}>
                    CATCH-UP ALERT
                  </span>
                </div>
                你只差 <strong style={{ color: '#C44818' }}>+60 PTS</strong> 就能超越{' '}
                <strong>Tanaka R.</strong> 衝上第 11 名 — 今天加把勁 🔥
              </div>
              <Eyebrow color="var(--ink-muted)" style={{ marginTop: 8 }}>Redirecting…</Eyebrow>
            </div>
          </div>
        )}
      </PaperCard>
